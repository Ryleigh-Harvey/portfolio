# -*- coding: utf-8 -*-
"""DataGenerationProj.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lktGHLFGESIc7yA30-AfspfoHz2ksTk7
...
"""The graph above compares distance traveled by various launchers, with "Stick, Paper, Rubber Band" as the most effective launcher."""
...
"""This graph evaluates the performance of different objects, with Dice achieving the distance among all the objects that were tested."""
...
"""This graph analyzes combinations of launchers and objects. "Stick, Paper, Rubber Band" paired with Dice achieves the greatest distance."""
...
"""This graph compares the accuracy of various launchers, showing that "Launcher1" has the highest accuracy, followed by "Launcher2" while other launchers have significantly lower accuracy.

We can conclude that the "Stick, Paper, Rubber Band" launcher combined with the "Dice" object was able to achieve the greatest distance of 500 inches which called for reasonable accuracy due to the consistent results in the Merged Dataset. We also saw how the "Stick, Paper, and Rubber Band" launcher outperformed all the other launching methods by a significant margin. However, the Dice came out to be optimal for distance due to their weight distribution and size which probably aligned with the launch force.

Launchets like "Stick, Paper, Rubber Band" and "V (Sticks and Rubber Band)" perform better than the other methods by a large margin which providied better control for direction.
In contrast, Launcher1 and Launcher2 perform poorly, which suggests the models were created terribly.

Dice exceled distance and accuracy for all methods because of the size and weight likely because all dice had the same size and weight. Erasers anbd rocks performed decently, which allowed a balance of weight and shape for propelling it. There seems to be a correltation between "Stick, Paper and Rubber Band' and "Dice" show both high performance in distance and repeatable accuracy, showing strong correlation.

This would be useful and beneficial to engineers and educators possibly interested in researching or teaching about various projectile systems and concepts such as physics and aerodynamics.
"""